...
After looking at the data the "numerical categorical data" was the best option because,VitC is a numerical variable that will explain by Cult which is a factor variable is categorical variable. This is how we knew what helper filer to upload. 
```{r}
